...
import { buildCodeMessages } from "@/lib/ai/code-prompts"
...
export async function POST(req: NextRequest) {
  ...
  const aiMessages = buildCodeMessages(
    chatSession.contentSnapshot ?? "",
    chatSession.language ?? "plaintext",
    history,
    userMessage,
    userRole
  )
